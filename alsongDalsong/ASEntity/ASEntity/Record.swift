...
extension Record {
    ...
    public enum AIRecord {
        public static let loser = Record(player: .playerStub2, recordOrder: 1, fileUrl: Bundle.main.url(forResource: "loser", withExtension: "mid")!)
        public static let superShy = Record(player: .playerStub2, recordOrder: 0, fileUrl: Bundle.main.url(forResource: "superShy", withExtension: "mid")!)
    }
